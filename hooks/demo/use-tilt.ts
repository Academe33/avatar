...
export default function useTilt({
  ...
  const timeoutRef = useRef<number | undefined>(undefined); // Corrected type for timeoutRef
  ...
  }, [maxAngle, isActive, targetAngle]); // Added targetAngle to dependencies for robust cleanup/rescheduling
